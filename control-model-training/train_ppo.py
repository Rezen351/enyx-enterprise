...
def train_ppo():
    ...
    entropy_callback = AdaptiveEntropyCallback(ent_start=0.005, ent_end=0.001, boost_factor=5.0, total_timesteps=total_timesteps)
    ...
    print(f"  n_epochs: 3")
    print(f"  gamma: 0.99")
    print(f"  ent_coef: 0.005 (adaptive)")
    print(f"  vf_coef: 0.3")
    print(f"  max_grad_norm: 1.0")
    print(f"  clip_range: 0.5")
