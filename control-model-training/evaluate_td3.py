...
def plot_stability_comparison(histories, out_path):
    ...
    for i, hist in enumerate(histories):
        ...
        ax1.axvspan(0, 12, alpha=0.06, color='gold', label='Day (06:00-18:00)')
        ax1.axvspan(12, 24, alpha=0.06, color='navy', label='Night (18:00-06:00)')
        ...
        ax1.set_xlabel('Time (h) [0h = 06:00 AM]')
        ...
        ax2.axvspan(0, 12, alpha=0.06, color='gold', label='Day (06:00-18:00)')
        ax2.axvspan(12, 24, alpha=0.06, color='navy', label='Night (18:00-06:00)')
        ...
        ax2.set_xlabel('Time (h) [0h = 06:00 AM]')
        ax2.set_ylabel('H_in (%)')
