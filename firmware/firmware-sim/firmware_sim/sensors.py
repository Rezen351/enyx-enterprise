...
_PROFILES: dict[str, tuple[str, float, float, float, float, int]] = {
    ...
    # SunnyBoy (Solar PV Inverter)
    "pv_volt":        ("V",    380.0, 15.0, 300.0, 480.0, 4095),
    "pv_curr":        ("A",      8.5, 1.5, 0.0, 15.0, 4095),
    "pv_pow":         ("W",   3200.0, 400.0, 0.0, 5000.0, 4095),
    "tegangan_sunnyboy": ("V", 380.0, 15.0, 300.0, 480.0, 4095),
    "arus_sunnyboy":  ("A",      8.5, 1.5, 0.0, 15.0, 4095),
    "daya_sunnyboy":  ("W",   3200.0, 400.0, 0.0, 5000.0, 4095),
    "tegangan_pv":    ("V",    380.0, 15.0, 300.0, 480.0, 4095),
    "arus_pv":        ("A",      8.5, 1.5, 0.0, 15.0, 4095),
    "daya_pv":        ("W",   3200.0, 400.0, 0.0, 5000.0, 4095),
    # SunnyIsland (Battery Inverter / Storage)
    "bat_volt":       ("V",     52.0, 1.5, 46.0, 56.0, 4095),
    "bat_curr":       ("A",     24.0, 4.0, 0.0, 50.0, 4095),
    "bat_pow":        ("W",   1250.0, 200.0, 0.0, 2500.0, 4095),
    "tegangan_sunnyisland": ("V", 52.0, 1.5, 46.0, 56.0, 4095),
    "arus_sunnyisland": ("A",   24.0, 4.0, 0.0, 50.0, 4095),
    "daya_sunnyisland": ("W", 1250.0, 200.0, 0.0, 2500.0, 4095),
    "tegangan_baterai": ("V",   52.0, 1.5, 46.0, 56.0, 4095),
    "arus_baterai":   ("A",     24.0, 4.0, 0.0, 50.0, 4095),
    "daya_baterai":   ("W",   1250.0, 200.0, 0.0, 2500.0, 4095),
    "battery_volt":   ("V",     52.0, 1.5, 46.0, 56.0, 4095),
    "battery_curr":   ("A",     24.0, 4.0, 0.0, 50.0, 4095),
    "battery_pow":    ("W",   1250.0, 200.0, 0.0, 2500.0, 4095),
    "battery_soc":    ("%",     85.0, 4.0, 20.0, 100.0, 100),
    "soc":            ("%",     85.0, 4.0, 20.0, 100.0, 100),
    # AC Electrical & Frequency
    "tegangan_ac":    ("V",    220.0, 4.0, 205.0, 235.0, 4095),
    "arus_ac":        ("A",      8.5, 2.0, 0.0, 25.0, 4095),
    "daya_ac":        ("W",   1850.0, 400.0, 0.0, 5000.0, 4095),
    "ac_volt":        ("V",    220.0, 4.0, 205.0, 235.0, 4095),
    "ac_curr":        ("A",      8.5, 2.0, 0.0, 25.0, 4095),
    "ac_pow":         ("W",   1850.0, 400.0, 0.0, 5000.0, 4095),
    "grid_volt":      ("V",    220.0, 4.0, 205.0, 235.0, 4095),
    "grid_curr":      ("A",      8.5, 2.0, 0.0, 25.0, 4095),
    "grid_pow":       ("W",   1850.0, 400.0, 0.0, 5000.0, 4095),
    "freq":           ("Hz",    50.0, 0.1, 49.5, 50.5, 4095),
    "frekuensi":      ("Hz",    50.0, 0.1, 49.5, 50.5, 4095),
    "frequency":      ("Hz",    50.0, 0.1, 49.5, 50.5, 4095),
    "energi":         ("kWh",  125.0, 2.0, 0.0, 9999.0, 4095),
    "energy":         ("kWh",  125.0, 2.0, 0.0, 9999.0, 4095),
    # Indonesian General Fallbacks
    "tegangan":       ("V",    220.0, 5.0, 200.0, 240.0, 4095),
    "arus":           ("A",      5.0, 1.5, 0.0, 25.0, 4095),
    "daya":           ("W",   1000.0, 200.0, 0.0, 5000.0, 4095),
    # Base English Fallbacks
